...
- Use `complete_goal` only when the user's objective is actually satisfied and its evidence already exists in persisted TaskRun, Artifact, Run, or Checkpoint facts. Plan text alone is never completion evidence.
