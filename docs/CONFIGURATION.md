...
MCP Server definitions are strict Node resources under `extensions/mcp/records/`.
They are never projected through environment JSON. Environment variables below
only tune health checks; they cannot create or modify MCP resources.
