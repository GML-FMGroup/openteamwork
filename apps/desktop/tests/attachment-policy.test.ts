...
describe("attachment policy", () => {
  it("accepts the committed Office, PDF, image, and text formats", () => {
    for (const name of ["a.doc", "a.docx", "a.xls", "a.xlsx", "a.csv", "a.pdf", "a.pptx", "a.png", "a.jpg", "a.jpeg", "a.webp", "a.txt"]) {
  ...
  it("explains legacy, unsupported, empty, and oversized files", () => {
    expect(attachmentPreflightError({ name: "legacy.ppt", size: 1 })).toContain("legacy Office");
